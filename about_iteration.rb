...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # You can add code to each element of the array. It start with a demo value 
    # it is possible to define the value of the demo, in this case 0 or 4
  end
  ...
  #   # code to read 'file'
  #   # Because the file name is not a local variable, it is something external
  #
