...
class AboutRegularExpressions < Neo::Koan
  def test_a_pattern_is_a_regular_expression
    assert_equal Regexp, /pattern/.class #It holds a regular expresion
  end
  ...
  def test_question_mark_means_optional
    ...
    assert_equal "a", "abbcccddddeeeee"[/az?/] #could be all or only a part
  end
  ...
  def test_asterisk_means_zero_or_more
    ...
    # when there is no a specify character
  end
  ...
  # Because it takes all the matches
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    ...
    assert_equal nil, "start end"[/\Aend/] #it has to be at the begining
  end
